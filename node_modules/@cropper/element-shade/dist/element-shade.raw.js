  ...
  class CropperShade extends CropperElement__default["default"] {
      ...
      connectedCallback() {
          ...
          if ($canvas) {
              ...
              if ($selection) {
                  ...
                  utils.on(window, utils.EVENT_RESIZE, this.$onWindowResize);
                  ...
                  utils.on($canvas, utils.EVENT_CHANGE, this.$onSelectionChange);
              }
          }
          this.$render();
      }
      disconnectedCallback() {
          ...
          if ($canvas) {
              if (this.$onWindowResize) {
                  utils.off(window, utils.EVENT_RESIZE, this.$onWindowResize);
                  this.$onWindowResize = null;
              }
              ...
              if (this.$onSelectionChange) {
                  utils.off($canvas, utils.EVENT_CHANGE, this.$onSelectionChange);
                  this.$onSelectionChange = null;
              }
          }
      ...
      $render() {
          return this.$setStyles({
              ...
              width: this.width,
              height: this.height,
              outlineWidth: utils.WINDOW.innerWidth * utils.WINDOW.devicePixelRatio,
          });
      }
  }
